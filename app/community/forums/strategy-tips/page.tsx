...
export default function StrategyTipsPage() {
  // Simulated forum posts data
  const posts = [
    {
      id: 1,
      title: 'Best PvP Builds for Warrior',
      author: 'DesertWarrior',
      date: '2026-03-19',
      replies: 98,
      views: 1876,
      lastReply: '2 hours ago',
      lastReplyAuthor: 'PvPExpert'
    },
    {
      id: 2,
      title: 'Mage DPS Guide - Maximize Your Damage',
      author: 'ArcaneMaster',
      date: '2026-03-18',
      replies: 76,
      views: 1543,
      lastReply: '4 hours ago',
      lastReplyAuthor: 'SpellWeaver'
    },
    {
      id: 3,
      title: 'Stealth Assassin Build - One Hit KO',
      author: 'ShadowStalker',
      date: '2026-03-17',
      replies: 112,
      views: 2098,
      lastReply: '6 hours ago',
      lastReplyAuthor: 'AssassinMain'
    },
    {
      id: 4,
      title: 'Tank Build Guide - Unkillable Frontline',
      author: 'IronWall',
      date: '2026-03-16',
      replies: 67,
      views: 1345,
      lastReply: '8 hours ago',
      lastReplyAuthor: 'TankMaster'
    },
    {
      id: 5,
      title: 'Healer Build - Support Your Team',
      author: 'LifeGiver',
      date: '2026-03-15',
      replies: 54,
      views: 1123,
      lastReply: '10 hours ago',
      lastReplyAuthor: 'HealingExpert'
    }
  ]
                  ...
                  {posts.map((post) => (
                    <tr key={post.id} className="hover:bg-desert-sand/10 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center">
                          <Link href={`/community/forums/strategy-tips/${post.id}`} className="font-medium text-rust-dark hover:text-desert-gold transition-colors">
                            {post.title}
                          </Link>
                        </div>
