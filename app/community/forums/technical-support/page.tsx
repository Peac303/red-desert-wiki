  ...
  const posts = [
    {
      ...
      lastReplyAuthor: 'FixedUser'
    },
    {
      id: 2,
      title: 'Performance Optimization Tips',
      author: 'PerformanceExpert',
      date: '2026-03-18',
      replies: 87,
      views: 1876,
      lastReply: '4 hours ago',
      lastReplyAuthor: 'OptimizedUser'
    },
    {
      id: 3,
      title: 'Connection Issues - Server Down?',
      author: 'NetworkUser',
      date: '2026-03-17',
      replies: 98,
      views: 2098,
      lastReply: '6 hours ago',
      lastReplyAuthor: 'ServerAdmin'
    },
    {
      id: 4,
      title: 'Graphics Glitches - Solutions',
      author: 'GraphicsExpert',
      date: '2026-03-16',
      replies: 67,
      views: 1567,
      lastReply: '8 hours ago',
      lastReplyAuthor: 'FixedGraphics'
    },
    {
      id: 5,
                  ...
                  {posts.map((post) => (
                    <tr key={post.id} className="hover:bg-desert-sand/10 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center">
                          <Link href={`/community/forums/technical-support/${post.id}`} className="font-medium text-rust-dark hover:text-desert-gold transition-colors">
                            {post.title}
                          </Link>
                        </div>
