...
export default function GuildRecruitmentPage() {
  ...
  const posts = [
    {
      id: 1,
      title: 'Guild Recruitment - The Desert Foxes',
      author: 'FoxLeader',
      date: '2026-03-19',
      replies: 45,
      views: 1234,
      lastReply: '2 hours ago',
      lastReplyAuthor: 'RecruitmentOfficer'
    },
    {
      id: 2,
      title: 'Looking for Active PvE Guild',
      author: 'PvEPlayer',
      date: '2026-03-18',
      replies: 34,
      views: 987,
      lastReply: '4 hours ago',
      lastReplyAuthor: 'GuildMaster'
    },
    {
      id: 3,
      title: 'Elite PvP Guild - Competitive Players Only',
      author: 'PvPCaptain',
      date: '2026-03-17',
      replies: 56,
      views: 1567,
      lastReply: '6 hours ago',
      lastReplyAuthor: 'Recruiter'
    },
    {
      id: 4,
      title: 'Casual Guild - New Players Welcome',
      author: 'CasualLeader',
      date: '2026-03-16',
      replies: 23,
      views: 765,
      lastReply: '8 hours ago',
      lastReplyAuthor: 'NewbiePlayer'
    },
    {
      id: 5,
      title: 'Looking for Guild with Trading Focus',
      author: 'TraderSeeker',
      date: '2026-03-15',
      replies: 18,
      views: 654,
      lastReply: '10 hours ago',
      lastReplyAuthor: 'TradeGuildLeader'
    }
  ]
                  ...
                  {posts.map((post) => (
                    <tr key={post.id} className="hover:bg-desert-sand/10 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center">
                          <Link href={`/community/forums/guild-recruitment/${post.id}`} className="font-medium text-rust-dark hover:text-desert-gold transition-colors">
                            {post.title}
                          </Link>
                        </div>
