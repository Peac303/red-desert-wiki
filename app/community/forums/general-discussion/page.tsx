  ...
  const posts = [
    {
      ...
      lastReplyAuthor: 'ExcitedPlayer'
    },
    {
      id: 2,
      title: 'What are your first impressions of Red Desert?',
      author: 'NewAdventurer',
      date: '2026-03-18',
      replies: 87,
      views: 1567,
      lastReply: '4 hours ago',
      lastReplyAuthor: 'VeteranGamer'
    },
    {
      id: 3,
      title: 'Favorite starting class?',
      author: 'ClassSelector',
      date: '2026-03-17',
      replies: 123,
      views: 2109,
      lastReply: '6 hours ago',
      lastReplyAuthor: 'ClassMaster'
    },
    {
      id: 4,
      title: 'Open world exploration tips',
      author: 'Explorer',
      date: '2026-03-16',
      replies: 56,
      views: 1234,
      lastReply: '8 hours ago',
      lastReplyAuthor: 'MapExpert'
    },
    {
      id: 5,
      title: 'Community meetup event planning',
      author: 'EventOrganizer',
      date: '2026-03-15',
      replies: 43,
      views: 987,
      lastReply: '10 hours ago',
      lastReplyAuthor: 'CommunityMember'
    }
  ]
                  ...
                  {posts.map((post) => (
                    <tr key={post.id} className="hover:bg-desert-sand/10 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center">
                          <Link href={`/community/forums/general-discussion/${post.id}`} className="font-medium text-rust-dark hover:text-desert-gold transition-colors">
                            {post.title}
                          </Link>
                        </div>
