...
export default function TradingEconomyPage() {
  // Simulated forum posts data
  const posts = [
    {
      id: 1,
      title: 'Market Trends - What\'s Hot Right Now',
      author: 'MarketAnalyst',
      date: '2026-03-19',
      replies: 87,
      views: 1678,
      lastReply: '2 hours ago',
      lastReplyAuthor: 'TradingExpert'
    },
    {
      id: 2,
      title: 'Best Items to Craft for Profit',
      author: 'CraftingMaster',
      date: '2026-03-18',
      replies: 65,
      views: 1456,
      lastReply: '4 hours ago',
      lastReplyAuthor: 'ProCraftsman'
    },
    {
      id: 3,
      title: 'Rare Resources Farming Guide',
      author: 'ResourceHunter',
      date: '2026-03-17',
      replies: 98,
      views: 1987,
      lastReply: '6 hours ago',
      lastReplyAuthor: 'FarmExpert'
    },
    {
      id: 4,
      title: 'Trading Hub Locations & Best Times',
      author: 'TraderJoe',
      date: '2026-03-16',
      replies: 54,
      views: 1234,
      lastReply: '8 hours ago',
      lastReplyAuthor: 'MerchantKing'
    },
    {
      id: 5,
      title: 'Economic Predictions for Next Patch',
      author: 'Economist',
      date: '2026-03-15',
      replies: 76,
      views: 1567,
      lastReply: '10 hours ago',
      lastReplyAuthor: 'MarketForecaster'
    }
  ]
                  ...
                  {posts.map((post) => (
                    <tr key={post.id} className="hover:bg-desert-sand/10 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center">
                          <Link href={`/community/forums/trading-economy/${post.id}`} className="font-medium text-rust-dark hover:text-desert-gold transition-colors">
                            {post.title}
                          </Link>
                        </div>
